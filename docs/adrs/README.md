...
| [0007](0007-multivalue-cold-load-and-input-allocation.md) | `MultiValueSnapshotTable` production validation: `Reset` cold-load, lean input, no parallel loader | Accepted (#43/#45/#46) |
